  ...
  return (
    <>
      ...
      <section id="mitglied" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-3xl p-5 sm:p-8 lg:p-12">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-anthrazit rounded-3xl p-5 sm:p-8 lg:p-12 text-white">
